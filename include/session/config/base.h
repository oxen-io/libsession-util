...
/// - `msg_hashes` -- [in] is an array of null-terminated C strings containing the hashes of the configs being
/// provided.
...
/// 32 bytes long.  The newly added key becomes the highest priority key: it will be used for encryption of
