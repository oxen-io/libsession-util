...
/// - `dump` -- [in] if non-NULL this restores the state from the dumped byte string produced by a past
...
///
/// Same as the above `contacts_get()` except that when the contact does not exist, this sets all the contact fields
