...
TEST_CASE("Hash generation", "[hash][hash]") {
    ...
    CHECK_THROWS(session::hash::hash(32, to_usv("TestMessage"),
        to_usv("KeyThatIsTooLongKeyThatIsTooLongKeyThatIsTooLongKeyThatIsTooLongKeyThatIsTooLong")));
    ...
    CHECK(hash1 != hash5);
    CHECK(hash3 != hash6);
    CHECK(oxenc::to_hex(hash1) == "2a48a12262e4548afb97fe2b04a912a02297d451169ee7ef2d01a28ea20286ab");
    ...
    CHECK(oxenc::to_hex(hash4) == "3d643e479b626bb2907476e32ccf7bdbd1ac3efa0da6e2c335255c48dcc216b6");

    auto expected_hash5 = "9d9085ac026fe3542abbeb2ea2ec05f5c37aecd7695f6cc41e9ccf39014196a39c02db69c44"
        "16d5c45acc2e9469b7f274992b2858f3bb2746becb48c8b56ce4b";
    auto expected_hash6 = "6a2faad89cf9010a4270cba07cc96cfb36688106e080b15fef66bb03c68e877874c9059edf5"
